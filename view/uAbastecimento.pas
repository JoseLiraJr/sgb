...
begin
  ...
  StartValues(pnAbastecimento, -1, True);
end;
...
begin
  with abastecimentoCto.Abastecimento do
   begin
     ...
     VlrLitro := GetVlrLitro(dmTabelas.dsBombas, dblBomba.KeyValue);
     edtVlrLitro.Text := FormatFloat(',0.00', VlrLitro);
   end;
end;
